...
syn region razorHTMLTag matchgroup=razorHTMLTag start=/\%#=1<\a\+/ end=/>/ display contains=razorHTMLAttribute
syn region razorHTMLTag start=/\%#=1<\// end=/>/ display

syn match razorHTMLAttribute /\%#=1\a\+\%(-\a\+\)*/ display contained nextgroup=razorHTMLAttribute,razorHTMLAttributeOperator skipwhite skipnl
